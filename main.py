...
@click.option("--changepoint-buffer", type=int, default=5, help="Number of initial points (changepoint buffer); if regression is in this buffer, expand window to re-validate (default: 5)")
@click.option("--expand-days", type=int, default=10, help="Days to add to lookback when expanding the window (default: 10)")
@click.option("--expand-points", type=int, default=5, help="Extra data points to request when expanding the window (default: 5)")
